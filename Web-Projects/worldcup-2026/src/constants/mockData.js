export const mockGroups = [
  ...
  },
  {
    name: "B",
    standings: [
      { code: "ca", team_name: "Canadá", played: 0, wins: 0, draws: 0, losses: 0, goals_for: 0, goals_against: 0, goal_difference: 0, points: 0 },
      { code: "ch", team_name: "Suiza", played: 0, wins: 0, draws: 0, losses: 0, goals_for: 0, goals_against: 0, goal_difference: 0, points: 0 },
      { code: "ba", team_name: "Bosnia-Herzegovina", played: 0, wins: 0, draws: 0, losses: 0, goals_for: 0, goals_against: 0, goal_difference: 0, points: 0 },
      { code: "qa", team_name: "Catar", played: 0, wins: 0, draws: 0, losses: 0, goals_for: 0, goals_against: 0, goal_difference: 0, points: 0 }
    ]
  },
  {
    name: "C",
  ...
  },
  {
    ...
    standings: [
      ...
      { code: "cd", team_name: "Congo RD", played: 0, wins: 0, draws: 0, losses: 0, goals_for: 0, goals_against: 0, goal_difference: 0, points: 0 }
    ]
  },
  {
    name: "L",
...
export const mockMatches = [
  ...
  // Round 1 - June 12
  { id: 3, home_team: "Canadá", away_team: "Suiza", home_score: 1, away_score: 1, kickoff_utc: "2026-06-12T17:00:00Z", status: "complete", phase: "Grupo B", stadium: "BC Place", round: "Grupo B" },
  { id: 26, home_team: "Bosnia-Herzegovina", away_team: "Catar", home_score: 1, away_score: 1, kickoff_utc: "2026-06-12T19:00:00Z", status: "complete", phase: "Grupo B", stadium: "BC Place", round: "Grupo B" },
  ...
  { id: 31, home_team: "Suecia", away_team: "Túnez", home_score: 5, away_score: 1, kickoff_utc: "2026-06-14T23:00:00Z", status: "complete", phase: "Grupo F", stadium: "Lumen Field", round: "Grupo F" },
  ...
  { id: 13, home_team: "Arabia Saudita", away_team: "Uruguay", home_score: 1, away_score: 1, kickoff_utc: "2026-06-15T21:00:00Z", status: "complete", phase: "Grupo H", stadium: "Cotton Bowl", round: "Grupo H" },
  ...
  // Round 2 - June 15
  { id: 27, home_team: "México", away_team: "Corea del Sur", home_score: 1, away_score: 0, kickoff_utc: "2026-06-15T17:00:00Z", status: "complete", phase: "Grupo A", stadium: "Estadio Azteca", round: "Grupo A" },
  { id: 28, home_team: "República Checa", away_team: "Sudáfrica", home_score: 1, away_score: 1, kickoff_utc: "2026-06-15T19:00:00Z", status: "complete", phase: "Grupo A", stadium: "Estadio Guadalajara", round: "Grupo A" },
  ...
  // Round 2 - June 16
  { id: 29, home_team: "Canadá", away_team: "Catar", home_score: 6, away_score: 0, kickoff_utc: "2026-06-16T19:00:00Z", status: "complete", phase: "Grupo B", stadium: "BC Place", round: "Grupo B" },
  { id: 30, home_team: "Suiza", away_team: "Bosnia-Herzegovina", home_score: 4, away_score: 1, kickoff_utc: "2026-06-16T21:00:00Z", status: "complete", phase: "Grupo B", stadium: "BC Place", round: "Grupo B" },

  // Round 1 - June 17
  { id: 32, home_team: "Argentina", away_team: "Argelia", home_score: 3, away_score: 0, kickoff_utc: "2026-06-17T17:00:00Z", status: "complete", phase: "Grupo J", stadium: "Estadio Azteca", round: "Grupo J" },
  { id: 33, home_team: "Austria", away_team: "Jordania", home_score: 3, away_score: 1, kickoff_utc: "2026-06-17T20:00:00Z", status: "complete", phase: "Grupo J", stadium: "SoFi Stadium", round: "Grupo J" },
  ...
  { id: 34, home_team: "Portugal", away_team: "Congo RD", home_score: 1, away_score: 1, kickoff_utc: "2026-06-18T23:00:00Z", status: "complete", phase: "Grupo K", stadium: "Hard Rock Stadium", round: "Grupo K" },
  { id: 35, home_team: "Inglaterra", away_team: "Croacia", home_score: 4, away_score: 2, kickoff_utc: "2026-06-18T18:00:00Z", status: "complete", phase: "Grupo L", stadium: "MetLife Stadium", round: "Grupo L" },
  { id: 36, home_team: "Ghana", away_team: "Panamá", home_score: 1, away_score: 0, kickoff_utc: "2026-06-18T21:00:00Z", status: "complete", phase: "Grupo L", stadium: "Lumen Field", round: "Grupo L" },

  // Round 2 - June 19 (Today)
  { id: 18, home_team: "Estados Unidos", away_team: "Australia", home_score: 2, away_score: 0, kickoff_utc: "2026-06-19T19:00:00Z", status: "live", phase: "Grupo D", stadium: "Lumen Field", round: "Grupo D" },
  { id: 19, home_team: "Brasil", away_team: "Haití", home_score: null, away_score: null, kickoff_utc: "2026-06-20T00:30:00Z", status: "scheduled", phase: "Grupo C", stadium: "AT&T Stadium", round: "Grupo C" },
  { id: 20, home_team: "Turquía", away_team: "Paraguay", home_score: null, away_score: null, kickoff_utc: "2026-06-20T03:00:00Z", status: "scheduled", phase: "Grupo D", stadium: "Gillette Stadium", round: "Grupo D" },
  { id: 21, home_team: "Escocia", away_team: "Marruecos", home_score: null, away_score: null, kickoff_utc: "2026-06-19T22:00:00Z", status: "scheduled", phase: "Grupo C", stadium: "Hard Rock Stadium", round: "Grupo C" },

  // Future matches
  { id: 22, home_team: "Alemania", away_team: "Ecuador", home_score: null, away_score: null, kickoff_utc: "2026-06-20T15:00:00Z", status: "scheduled", phase: "Grupo E", stadium: "Levi's Stadium", round: "Grupo E" },
  { id: 23, home_team: "Costa de Marfil", away_team: "Curazao", home_score: null, away_score: null, kickoff_utc: "2026-06-20T18:00:00Z", status: "scheduled", phase: "Grupo E", stadium: "Hard Rock Stadium", round: "Grupo E" },
  { id: 24, home_team: "Países Bajos", away_team: "Suecia", home_score: null, away_score: null, kickoff_utc: "2026-06-20T21:00:00Z", status: "scheduled", phase: "Grupo F", stadium: "Mercedes-Benz Stadium", round: "Grupo F" },
  { id: 25, home_team: "Japón", away_team: "Túnez", home_score: null, away_score: null, kickoff_utc: "2026-06-20T23:00:00Z", status: "scheduled", phase: "Grupo F", stadium: "Lumen Field", round: "Grupo F" }
];
